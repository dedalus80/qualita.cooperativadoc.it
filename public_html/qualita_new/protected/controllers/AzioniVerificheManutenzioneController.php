...
class AzioniVerificheManutenzioneController extends Controller {
    ...
    public function actionModello() {
        $model = new AzioniVerificheManutenzione('search');
        ...
        $html2pdf->Output('modello-verifica-ispettiva-manutenzione.pdf', 'D');
    }
    ...
    public function actionCreate() {
        $model = new AzioniVerificheManutenzione;
        $model->setDefaultValue();
        if (isset($_POST['AzioniVerificheManutenzione'])) {

            $model->attributes = $_POST['AzioniVerificheManutenzione'];
            ...
            if ($model->save()) {
                ...
                Yii::app()->user->setFlash('opResultOK', 'Verifica manutenzione  <b>' . $model->codice_verifica . "</b> creata con successo");
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['AzioniVerificheManutenzione'])) {
            ...
            if ($model->save()) {
                ...
                Yii::app()->user->setFlash('opResultOK', 'Verifica manutenzione  <b>' . $model->codice_verifica . "</b> aggiornata con successo");
                $this->redirect(array('admin'));
            }
        }
    ...
    public function actionDelete($id) {
        $model = $this->loadModel($id);
        Yii::app()->user->setFlash('opResultOK', 'Verifica manutenzione  <b>' . $model->codice_verifica . "</b> rimossa con successo");
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('AzioniVerificheManutenzione');
    ...
    public function loadModel($id) {
        $model = AzioniVerificheManutenzione::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'azioni-verifiche-manutenzione-form') {
