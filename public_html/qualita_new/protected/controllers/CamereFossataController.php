...
class CamereFossataController extends Controller{
	...
	public function actionCreate()	{
        ...
        $model=new CamereFossata;
		if(isset($_POST['CamereFossata']))		{
			$model->attributes=$_POST['CamereFossata'];
			if ($model->save()) {
	...
	public function actionAdmin()	{
		$model=new CamereFossata('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CamereFossata']))
			$model->attributes=$_GET['CamereFossata'];
	...
	protected function performAjaxValidation($model)	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='camere-fossata-form')	{
