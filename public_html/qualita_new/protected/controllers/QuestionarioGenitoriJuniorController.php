...
class QuestionarioGenitoriJuniorController extends Controller {
    ...
    public function actionEsporta($anni = null) {
        $model = new QuestionarioGenitoriJunior('search');
    ...
    public function actionGrafici($struttura= null, $anno = null, $gruppo = null, $turno= null) {
        ...
        $model = new QuestionarioGenitoriJunior;
    ...
    public function actionAdmin() {
        ...
        if (isset($_GET['QuestionarioGenitoriJunior']))
            $model->attributes = $_GET['QuestionarioGenitoriJunior'];
    ...
    public function loadModel($id) {
        $model = QuestionarioGenitoriJunior::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'questionario-genitori-junior-form') {
