...
class QuestionarioGenitoriSeniorController extends Controller {
    ...
    public function actionEsporta($anni = null) {
        $model = new QuestionarioGenitoriSenior('search');
    ...
    public function actionGrafici($struttura= null, $anno = null, $gruppo = null, $turno= null) {
        ...
        $model = new QuestionarioGenitoriSenior;
    ...
    public function actionAdmin() {
        ...
        if (isset($_GET['QuestionarioGenitoriSenior']))
            $model->attributes = $_GET['QuestionarioGenitoriSenior'];
    ...
    public function loadModel($id) {
        $model = QuestionarioGenitoriSenior::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'questionario-genitori-senior-form') {
