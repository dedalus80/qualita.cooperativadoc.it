...
class QuestionarioJuniorController extends Controller {
    ...
    public function accessRules() {
        return array(
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('admin', 'delete', 'view', 'esporta', 'grafici', 'update', 'smile','stampaGrafici'),
    ...
    public function actionEsporta($anni = null) {
        $model = new QuestionarioJunior('search');
    ...
    public function actionGrafici($struttura= null, $anno = null, $gruppo = null, $turno= null) {
        ...
        $model->stats               = Yii::app()->MyStats->getStatsQuestionari("questionario_junior", $struttura,$model->anno);
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['QuestionarioJunior'])) {
            $model->attributes = $_POST['QuestionarioJunior'];
            $model->setAttribute('data_restituzione', Yii::app()->MyUtils->reverseDate($model->data_restituzione));
            if ($model->save()) {
                Yii::app()->user->setFlash('opResultOK', 'Questionario junior <b>' . $model->nome . " " . $model->cognome . "</b> aggiornato con successo");
    ...
    public function actionSmile() {
        ...
        $model = new QuestionarioJunior('search');
        $model->smile = Yii::app()->MyUtils->getSoddisfazione();
        $this->render('smile', array('model' => $model,));
    }
    ...
    public function loadModel($id) {
        $model = QuestionarioJunior::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'questionario-junior-form') {
