...
/**
 * This is the model class for table "doc_documenti_qualita".
 *
 * The followings are the available columns in table 'doc_documenti_qualita':
 * @property integer $id
 ...
 * @property DocumentiQualitaProcedura $procedura
 * @property DocumentiQualitaUnita[] $documentiQualitaUnitas
 */
class DocumentiQualita extends CActiveRecord
{
	 ...
	 * @return DocumentiQualita the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			...
			'procedura' => array(self::BELONGS_TO, 'DocumentiQualitaProcedura', 'procedura_id'),
			'documentiQualitaUnitas' => array(self::HAS_MANY, 'DocumentiQualitaUnita', 'documenti_id'),
		);
	}
	...
	public function afterSave()
	{
		if($this->scenario == 'update' && $this->document){
			@unlink(Yii::app()->basePath.'/documenti/'.$this->oldFilename);
		}
	}
}