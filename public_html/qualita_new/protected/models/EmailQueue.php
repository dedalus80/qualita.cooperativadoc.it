...
/**
 * This is the model class for table "doc_email_queue".
 *
 * The followings are the available columns in table 'doc_email_queue':
 * @property string $id
...
class EmailQueue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_user, from_email, to_email, subject, message', 'required'),
			...
			array('id, id_user, from_name, from_email, to_email, subject, message, max_attempts, attempts, success, date_published, last_attempt, date_sent', 'safe', 'on'=>'search'),
		);
	}
