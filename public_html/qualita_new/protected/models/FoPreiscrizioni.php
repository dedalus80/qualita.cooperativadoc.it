...
class FoPreiscrizioni extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, nome, cognome, data_nascita, luogo_nascita, nazionalita, sesso, email, cellulare, occupazione, prima_volta, conoscenza, formula, campus, housing, coabitazione, data_in, data_out, privacy, mailing, note, data_insert', 'safe', 'on' => 'search'),
        );
    }
	...
	public function getRefer($data , $t){
        return $data->refer =='S' ?  "Cascina Fossata":"Politecnico";
    }
    ...
    public function setSelectValue() {
        ...
        $this->selectRefer = array("S"=>"Sito Cascina Fossata", "P"=>"Sito Politecnico");
    }
    ...
    public function getEsportazione($anni = null) {
        ...
        $query = " SELECT q.refer , q.id , q.nome , q.cognome, q.luogo_nascita,formula, DATE_FORMAT(q.data_nascita ,'%d-%m-%Y' ) as nascita 
            ...
            c.nome as nome_conoscenza , f.nome as nome_formula ,fc.nome as nome_campus, fh.nome as nome_housing ,q.note , q.anno 
            FROM fo_preiscrizioni as q
