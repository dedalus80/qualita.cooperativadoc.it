...
class QuestionarioSenior extends CActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('divertimento, educatori, compagni, giochi, attivita_sportive, gite, laboratori, escursioni, soggiorno_esperienza, soggiorno_staff, soggiorno_communicazione, soggiorno_complessivo', 'length', 'max' => 1),
            array('id, nome,nome_gruppo, cognome, organizzatore, soggiorno, turno, email, cellulare, divertimento, educatori, compagni, giochi, attivita_sportive, gite, laboratori, escursioni, soggiorno_esperienza, soggiorno_staff, soggiorno_communicazione, soggiorno_complessivo, suggerimenti, data_restituzione, anno', 'safe', 'on' => 'search'),
        );
    }
    ...
    function setSelect() {
        ...
        $this->selectSoggiorni = Yii::app()->MyUtils->getSelect('doc_unita_senior');
    ...
    public function getEsportazione($anni = null) {
        ...
        $query = "SELECT s.*, DATE_FORMAT(s.data_restituzione ,'%d-%m-%Y' ) as restituzione , c.nome as organizza, u.nome as struttura
            ...
            WHERE s.tipologia_id = 2 ".$where_year;
    ...
    public function getAllStats() {
        ...
        $campi = array('divertimento', 'educatori', 'compagni', 'giochi', 'attivita_sportive', 'gite', 'laboratori', 'escursioni', 'soggiorno_esperienza', 'soggiorno_staff', 'soggiorno_communicazione', 'soggiorno_complessivo');
