...
class QuestionarioStudio extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('suggerimenti , osservazioni , studio_aspetto_vacanza , studio_attivita_utile , studio_suggerimenti', 'length', 'max' => 255),
            array('divertimento, educatori, compagni, giochi, attivita_sportive, gite, laboratori, escursioni, soggiorno_esperienza, soggiorno_staff, soggiorno_communicazione, soggiorno_complessivo, studio_localita, studio_college, studio_attivita, studio_corso, studio_escursioni, studio_divertimento', 'length', 'max' => 1),
            array('id, nome, cognome,nome_gruppo, organizzatore, soggiorno, turno, email, cellulare, divertimento, educatori, compagni, giochi, attivita_sportive, gite, laboratori, escursioni, soggiorno_esperienza, soggiorno_staff, soggiorno_communicazione, soggiorno_complessivo, studio_localita, studio_college, studio_attivita, studio_corso, studio_escursioni, studio_divertimento, studio_aspetto_vacanza, studio_attivita_utile, studio_suggerimenti, suggerimenti, data_restituzione, anno', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'studio_college' => 'Ti &egrave; piaciuto il college presso cui si &egrave; svolta la vacanza studio?',
            ...
            'studio_aspetto_vacanza' => 'Quale aspetto della vacanza studio hai apprezzato di pi&ugrave;?',
            'studio_attivita_utile' => 'Quale attivit&agrave; hai ritenuto pi&ugrave; utile alla tua formazione linguistica?',
    ...
    function setSelect() {
        ...
        $this->selectSoggiorni = Yii::app()->MyUtils->getSelect('doc_unita_studio');
    ...
    public function getEsportazione($anni = null) {
        ...
        $query = "SELECT s.*, DATE_FORMAT(s.data_restituzione ,'%d-%m-%Y' ) as restituzione , c.nome as organizza, u.nome as struttura
            ...
            WHERE s.tipologia_id = 3 ".$where_year;
    ...
    public function getAllStats() {
        ...
        $campi = array('divertimento', 'educatori', 'compagni', 'giochi', 'attivita_sportive', 'gite', 'laboratori', 'escursioni', 'soggiorno_esperienza', 'soggiorno_staff', 'soggiorno_communicazione', 'soggiorno_complessivo', 'studio_localita', 'studio_college', 'studio_attivita', 'studio_corso', 'studio_escursioni', 'studio_divertimento');
