...
class UtenzeChimici extends CActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            ...
            'media_litri_ospiti' => 'Litri / Ospite',
            'media_litri_superfice' => ' Litri / Mq',
            'anno' => 'Anno',
            'gennaio' => 'Gennaio',
            'febbraio' => 'Febbraio',
            'marzo' => 'Marzo',
    ...
    public function getEuroSuperficie($data, $t){
        return Yii::app()->MyUtils->getMediaConsumi($data->struttura,$this->tableName(),$data->anno,"superficie_unita");
    }
    
    public function getLitriSuperficie($data, $t){
        return Yii::app()->MyUtils->getMediaConsumi($data->struttura,$this->tableName(),$data->anno,"superficie");
    }
    
    public function getEuroOspiti($data, $t){
        return Yii::app()->MyUtils->getMediaConsumi($data->struttura,$this->tableName(),$data->anno);
    }
    
    public function getLitriOspiti($data, $t){
        return Yii::app()->MyUtils->getMediaConsumi($data->struttura,$this->tableName(),$data->anno,"consumo");
    }
    ...
    public function getEsportazione($anno = NULL) {
        ...
        $query = " SELECT r.* , u.nome as nome_unita FROM ".$this->tableName()." as r
