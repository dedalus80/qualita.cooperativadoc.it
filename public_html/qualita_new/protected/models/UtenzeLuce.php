...
class UtenzeLuce extends CActiveRecord {
    ...
    public function getKwhSuperficie($data, $t){
    ...
    public function getKwhOspiti($data, $t){
    ...
    public function getEsportazione($anno = NULL) {
        ...
        $query = " SELECT r.* , u.nome as nome_unita FROM utenze_luce as r
