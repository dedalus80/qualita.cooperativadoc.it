...
class UtenzeRifiuti extends CActiveRecord {
    ...
    public function setSelect() {
        ...
        if ($this->presenze > 0)
            $this->c_media_utenti = Yii::app()->MyUtils->getMediaConsumi($this->struttura,$this->tableName(),$this->anno); 
