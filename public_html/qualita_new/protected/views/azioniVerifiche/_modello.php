...
?>
            ...
            <tr>
                ...
                <td class='' style="text-align:left; width: 25%;padding-top: 5px" >
                    <div class="box-codice">
                        <?php echo $model->codice;?><br />
                        del .../.../......
                    </div>
                </td>
            </tr>
            <tr>
                <td class='intro-big' colspan="2" style="padding: 30px 0px ; width: 100% "><?php echo $model->nome;?></td>
            </tr>
        </table>
    ...
    <page pageset=""  class="" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm" > 
        ...
        <table style='width:100%; margin-top: 25px;'  cellspacing="0" cellpadding="0">
            ...
            <tr class="row-border">
                <td class='intestazione-quesito <?= $bg ?>'><?php echo utf8_decode($domanda['question']);?></td>
