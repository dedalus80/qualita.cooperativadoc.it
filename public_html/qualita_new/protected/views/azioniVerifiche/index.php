...
$this->breadcrumbs = array(
    'Verifiche Ispettive' => $idTipoVerifica ? array('index', 'id'=>$idTipoVerifica) : array('index'),
    'Gestione',
);

$isCategoriaFilter = !empty($idTipoVerifica);
$titoloVerifiche = $isCategoriaFilter ? 'Verifiche <span class="hidden-480">ispettive</span>' : 'Tutte le verifiche <span class="hidden-480">assegnate</span>';
$searchTitle = $isCategoriaFilter ? 'Verifiche sicurezza' : 'Tutte le verifiche';
...
<div class="panel panel-default panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-check'></i>&nbsp;<?php echo $titoloVerifiche; ?></h2>
        <div class="panel-ctrls">
            <ul class="demo-btns">
                ...
                <?php if ($isCategoriaFilter): ?>
                    <li><?php echo CHtml::link('<i class="fa fa-download"></i>', Yii::app()->createUrl("azioniVerifiche/modello", array("id"=>$model->tipo_verifica)), array('class' => 'open-download button-icon button-icon-orange', 'id' => '', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Scarica modello verifica ispettiva'))); ?></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
    <div class="panel-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'id' => 'azioni-verifiche-sicurezza-grid',
            ...
            'columns' => array(
                ...
                array(
                    'name' => 'data',
                    'value' => '$data->data ? date("d-m-Y", strtotime($data->data)) : 0',
                    'htmlOptions' => array('class' => 'hidden-480 '),
                    'headerHtmlOptions' => array('class' => 'hidden-480 '),
                ),
                array(
                    'name' => 'ora_inizio',
                    'value' => 'substr($data->ora_inizio,0,5)',
                    'htmlOptions' => array('class' => 'hidden-480 '),
                    'headerHtmlOptions' => array('class' => 'hidden-480 '),
                ),
                array(
                    'name' => 'ora_fine',
                    'value' => 'substr($data->ora_fine,0,5)',
                    'htmlOptions' => array('class' => 'hidden-480 '),
                    'headerHtmlOptions' => array('class' => 'hidden-480 '),
                ),
                array(
                    'name' => 'incaricato',
                    'value' => array($model, 'getIncaricato'),
                    'htmlOptions' => array('class' => 'hidden-480 '),
                    'headerHtmlOptions' => array('class' => 'hidden-480 '),
                ),
                array(
                ...
                array(
                    ...
                    'value' => '$data->tipo_valutazione ? $data->tipo_valutazione == "V" ? "VALUTAZIONE":"AUTOVALUTAZIONE" : ""',
                    'htmlOptions' => array('class' => 'hidden-480'),
                    'headerHtmlOptions' => array('class' => 'hidden-480'),
                ),
                array(
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("azioniVerifiche/compila", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("azioniVerifiche/stampa", array("id"=>$data->id))',
    ...
    <div class="modal-dialog" style="max-width: 500px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" ><i class='fa fa-check'></i>&nbsp; <?php echo $searchTitle; ?></h4>
            </div>
            <div class="modal-body">
                <?php $this->renderPartial('_search', array('model' => $model, 'idTipoVerifica'=>$idTipoVerifica)); ?>   
            </div>
