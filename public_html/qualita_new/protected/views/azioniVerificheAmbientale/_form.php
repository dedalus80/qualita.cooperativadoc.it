<?php
$form = $this->beginWidget('CActiveForm', array('id' => 'azioni-verifiche-ambientale-form', 'enableAjaxValidation' => true, 'htmlOptions' => array('enctype' => 'multipart/form-data'), 'clientOptions' => array('validateOnSubmit' => true,),));
?>
<div>
    ...
    <div class="row">
        <div class="col-xs-12">
			<legend>Incaricato<span class='hidden-480'> verifica</span>: <span class='orange'> <?= Yii::app()->MyUtils->getSelectValue($model->autore,'dettaglio_admin')  ?></span></legend>
        </div>
    </div>
    <div class="row row-10">
        <div class="col-xs-12 col-sm-2 ">
            ...
            <div class="input-group date" >
                <span class="input-group-addon data-calendar" data-refer="AzioniVerificheAmbientale_data"><i class="fa fa-calendar"></i></span>
        ...
        <div class="col-xs-6 col-sm-2 ">
            ...
            <div class="input-group">							
                <span class="input-group-addon"><i class="fa fa-clock-o data-timer" data-refer='AzioniVerificheAmbientale_ora_inizio' ></i></span>
        ...
        <div class="col-xs-6 col-sm-2 ">
            ...
            <div class="input-group">							
                <span class="input-group-addon"><i class="fa fa-clock-o data-timer" data-refer='AzioniVerificheAmbientalr_ora_fine' ></i></span>
    ...
    <div class="row row-10 descrizione">
        <div class="col-xs-12 ">
            <p>La check list di BASE &egrave; articolata in <b>3 sezioni</b><br />
                ...
                Il valutatore indichi il giudizio UNICAMENTE con le sigle: (voce conforme), <b>NC</b> (voce non conforme), <b>NA</b> (non applicabile), <b>NR</b> (non rilevata)</p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div id="collapse_<?= $k ?>" class="collapse <?= $k == 1 ? 'in' : '' ?> " aria-expanded="<?= $k == 1 ? 'true' : 'false' ?>"  style="">
                            <div class="panel-body panel-body-verifica"  style='padding-top: 0px' id='panel-verifica-<?= $k ?>' >
                                ...
                                for ($x = 0; $x < count($model->campiSezioni['sezione_' . $k]); $x++) {
                                    if ($k == 2 && $x == '0')
                                        echo '<div class="row row-10 sub-intestazione-sezione pdl"><div class="col-xs-12 ">IL SISTEMA DI GESTIONE AMBIENTALE &Egrave; STATO CORRETTAMENTE IMPLEMENTATO? <br />NELLO SPECIFICO SONO STATI CORRETTAMENTE COMPLETATI I SEGUENTI DOCUMENTI? (RILEVAMENTO DI ALMENO 2 CAMPIONI DI 2 GRUPPI DI RIFERIMENTO).</div></div>';
                                    ?>
    ...
    <div class="panel-footer">
        <div class="pull-right">
            <?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange btn-submit-form ', 'data-refer' => 'azioni-verifiche-ambientale-form')); ?>
        </div>
    </div>
    <?php $this->endWidget(); ?>
</div>
