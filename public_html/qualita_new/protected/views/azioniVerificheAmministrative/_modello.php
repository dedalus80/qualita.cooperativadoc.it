...
for ($k = 1; $k <= count($model->campiSezioni); $k++) {
    ...
    <page pageset=""  class="" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm" > 
        ...
        <table style='width:100%;' class="">
            ...
            <tr>
                <td class='intro-big' colspan="2" style="padding: 30px 0px ; width: 100%; text-align: center ">Verifica Ispettiva Amministrazione</td>
            </tr>
        </table>
                ...
                <?php if ($k == 1 && $x == 1) { ?>
                    <tr class="row-border-grey">
                        <td colspan='4' style='width:100%;' >
                            PER OGNI LAVORATORE  SONO STATI CONSEGNATI E CONTROFIRMATI I SEGUENTI DOCUMENTI - ALMENO 3 NOMINATIVI A CAMPIONE
                        </td>
                    </tr>                 
                <?php } ?>

                <?php if (($k == 2 && $x == 11) || ($k == 3 && $x == 8) || ($k == 1 && $x == 11)) { ?>
                </table>
            </page>
            <page pageset=""  class="" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm" > 
                <page_header>
                ...
                <table style='width:100%;' class="">
                    ...
                    <tr>
                        <td class='intro-big' colspan='2' style="padding: 30px 0px ; width: 100% ">Verifica Ispettiva Amministrazione</td>
                    </tr>
                </table>
                <table style='width:100%;' class="intro-table">    
                    <tr>
