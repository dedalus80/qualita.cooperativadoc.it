...
$this->breadcrumbs = array(
    'Verifiche Ispettive amministrative' => array('admin'),
    'Gestione',
);
...
<div class="panel panel-default panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-check'></i>&nbsp;Verifiche <span class="hidden-480">ispettive </span>amministrative</h2>
    ...
    <div class="panel-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'id' => 'azioni-verifiche-amministrative-grid',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("azioniVerificheAmministrative/update", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("azioniVerificheAmministrative/stampa", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"azioniVerificheAmministrative" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
    ...
    <div class="modal-dialog" style="max-width: 500px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" ><i class='fa fa-check'></i>&nbsp; Verifiche amministrative</h4>
            </div>
