<?php
$form = $this->beginWidget('CActiveForm', array('id' => 'azioni-verifiche-educative-form', 'enableAjaxValidation' => true, 'htmlOptions' => array('enctype' => 'multipart/form-data'), 'clientOptions' => array('validateOnSubmit' => true,),));
?>
<div>
                        ...
                        <div id="collapse_<?= $k ?>" class="collapse <?= $k == 1 ? 'in' : '' ?> " aria-expanded="<?= $k == 1 ? 'true' : 'false' ?>"  style="">
                            <div class="panel-body panel-body-verifica"  style='padding-top: 0px' id='panel-verifica-<?= $k ?>' >
                                ...
                                for ($x = 0; $x < count($model->campiSezioni['sezione_' . $k]); $x++) {
                                    if ($k == 2 && $x == '0')
                                        echo '<div class="row row-10 sub-intestazione-sezione "><div class="col-xs-12 ">STRUMENTI DEL DIRETTORE</div></div>';
                                    if ($k == 2 && $x == '8')
                                        echo '<div class="row row-10 sub-intestazione-sezione "><div class="col-xs-12 ">STRUMENTI DEL COORDINATORE</div></div>';
    ...
    <div class="panel-footer">
        <div class="pull-right">
            <?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange btn-submit-form ', 'data-refer' => 'azioni-verifiche-educative-form')); ?>
        </div>
    </div>
    <?php $this->endWidget(); ?>
</div>