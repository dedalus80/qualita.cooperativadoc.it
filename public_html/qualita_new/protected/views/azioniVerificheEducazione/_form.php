<?php
$form = $this->beginWidget('CActiveForm', array('id' => 'azioni-verifiche-educazione-form', 'enableAjaxValidation' => true, 'htmlOptions' => array('enctype' => 'multipart/form-data'), 'clientOptions' => array('validateOnSubmit' => true,),));
?>
<div>
    ...
    <div class="row row-10">
        <div class="col-xs-12 col-sm-2 ">
            ...
            <div class="input-group date" >
                <span class="input-group-addon data-calendar" data-refer="AzioniVerificheEducazione_data"><i class="fa fa-calendar"></i></span>
        ...
        <div class="col-xs-6 col-sm-2 ">
            ...
            <div class="input-group">							
                <span class="input-group-addon"><i class="fa fa-clock-o data-timer" data-refer='AzioniVerificheEducazione_ora_inizio' ></i></span>
        ...
        <div class="col-xs-6 col-sm-2 ">
            ...
            <div class="input-group">							
                <span class="input-group-addon"><i class="fa fa-clock-o data-timer" data-refer='AzioniVerificheEducazione_ora_fine' ></i></span>
                        ...
                        <div id="collapse_<?= $k ?>" class="collapse <?= $k == 1 ? 'in' : '' ?> " aria-expanded="<?= $k == 1 ? 'true' : 'false' ?>"  style="">
                            <div class="panel-body panel-body-verifica"  style='padding-top: 0px' id='panel-verifica-<?= $k ?>' >
                                <div class="row row-10 intestazione-sezione hidden-480">
                                    <div class="col-xs-12 col-sm-5 centered">PARAMETRO DA VALUTARE</div>
                                ...
                                for ($x = 0; $x < count($model->campiSezioni['sezione_' . $k]); $x++) {
                                    if ($k == 2 && $x == '0')
                                        echo '<div class="row row-10 intestazione-sezione btop"><div class="col-xs-12 ">IL SISTEMA DI GESTIONE AMBIENTALE è STATO CORRETTAMENTE IMPLEMENTATO?NELLO SPECIFICO SONO STATI CORRETTAMENTE COMPLETATI I SEGUENTI DOCUMENTI? (RILEVAMENTO DI ALMENO 2 CAMPIONI DI 2 GRUPPI DI RIFERIMENTO).</div></div>';
                                    ?>
    ...
    <div class="panel-footer">
        <div class="pull-right">
            <?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange btn-submit-form ', 'data-refer' => 'azioni-verifiche-educazione-form')); ?>
        </div>
    </div>
    <?php $this->endWidget(); ?>
</div>