...
for ($k = 1; $k <= count($model->campiSezioni); $k++) {
    ...
    <page pageset=""  class="" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm" > 
        ...
        <table style='width:100%;' class="">
            ...
            <tr>
                <td class='intro-big' colspan="2" style="padding: 30px 0px ; width: 100% ">Verifica Ispettiva Pulizia e Manutenzione </td>
            </tr>
        </table>
        ...
        <table style='width:100%; margin-top: 15px;'  cellspacing="0" cellpadding="0">
            ...
            <page pageset=""  class="" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm" > 
                ...
                <table style='width:100%;' class="">
                    ...
                    <tr>
                        <td class='intro-big' colspan="2" style="padding: 30px 0px ; width: 100% ">Verifica Ispettiva Settore Pulizia e Manuntenzione </td>
                    </tr>
                </table>
                <table style='width:100%;' class="intro-table">    
                    <tr>
