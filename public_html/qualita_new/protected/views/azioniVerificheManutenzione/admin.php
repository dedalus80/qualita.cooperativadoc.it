...
$this->breadcrumbs = array(
    'Verifiche Ispettive pulizia e manutenzione' => array('admin'),
    'Gestione',
);
...
<div class="panel panel-default panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-check'></i>&nbsp;Verifiche <span class="hidden-480">ispettive </span>pulizia e manutenzione</h2>
    ...
    <div class="panel-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'id' => 'azioni-verifiche-manutenzione-grid',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("azioniVerificheManutenzione/update", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("azioniVerificheManutenzione/stampa", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"azioniVerificheManutenzione" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
    ...
    <div class="modal-dialog" style="max-width: 500px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" ><i class='fa fa-check'></i>&nbsp; Verifiche pulizia e manutenzione</h4>
            </div>
