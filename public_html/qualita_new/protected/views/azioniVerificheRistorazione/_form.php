<?php
$form = $this->beginWidget('CActiveForm', array('id' => 'azioni-verifiche-ristorazione-form', 'enableAjaxValidation' => true, 'htmlOptions' => array('enctype' => 'multipart/form-data'), 'clientOptions' => array('validateOnSubmit' => true,),));
?>
<div>
    ...
    <div class="row row-10">
        <div class="col-xs-12 col-sm-2 ">
            ...
            <div class="input-group date" >
                <span class="input-group-addon data-calendar" data-refer="AzioniVerificheRistorazione_data"><i class="fa fa-calendar"></i></span>
        ...
        <div class="col-xs-6 col-sm-2 ">
            ...
            <div class="input-group">							
                <span class="input-group-addon"><i class="fa fa-clock-o data-timer" data-refer='AzioniVerificheRistorazione_ora_inizio' ></i></span>
        ...
        <div class="col-xs-6 col-sm-2 ">
            ...
            <div class="input-group">							
                <span class="input-group-addon"><i class="fa fa-clock-o data-timer" data-refer='AzioniVerificheRistorazione_ora_fine' ></i></span>
...
<?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange btn-submit-form ', 'data-refer' => 'azioni-verifiche-ristorazione-form')); ?>
        </div>
    </div>
<?php $this->endWidget(); ?>
</div>