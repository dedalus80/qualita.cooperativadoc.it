...
for ($k = 1; $k <= count($model->campiSezioni); $k++) {
    ...
    <page pageset=""  class="" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm" > 
        ...
        <table style='width:100%;' class="">
            ...
            <tr>
                <td class='intro-big' colspan='2' style="padding: 30px 0px ; width: 100% ">Verifica Ispettiva Ristorazione e Stoccaggio<br />Codice: <?= $model->codice_verifica ?></td>
            </tr>
        </table>
            ...
            for ($x = 0; $x < count($model->campiSezioni['sezione_' . $k]); $x++) {
                ...
                <?php if ($k == 2 && $x == 0) { ?>
                    <tr class="row-border-grey">
                        <td colspan="2">Un prodotto ortofrutticolo:INDICARE QUALE DERRATA SCELTA  </td>
                        <td ><?= $model->derrata_orto_prodotto ?> </td>
                    </tr>                 
                <?php } ?>      
                <?php if ($k == 2 && $x == 10) { ?>
                    <tr class="row-border-grey">
                        <td colspan="2">Un prodotto carne:INDICARE QUALE DERRATA SCELTA  </td>
                        <td ><?= $model->derrata_carne_prodotto ?> </td>
                    </tr>                 
                <?php } ?> 
                <?php if ($k == 2 && $x == 20) { ?>
                    <tr class="row-border-grey">
                        <td colspan="2">Un prodotto secco:INDICARE QUALE DERRATA SCELTA </td>
                        <td ><?= $model->derrata_secco_prodotto ?> </td>
                    </tr>                 
                <?php } ?> 
                <?php if (($k == 4 && $x == 12) || ($k == 6 && $x == 13) || ($k == 10 && $x == 13) || ($k == 2 && $x == 17)) { ?>
                </table>
            </page>
            <page pageset=""  class="" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm" > 
                <page_header>
                ...
                <table style='width:100%;' class="">
                    ...
                    <tr>
                        <td class='intro-big' style="padding: 30px 0px ; width: 100% ">Verifica Ispettiva Settore Manuntenzione<br />Codice: <?= $model->codice_verifica ?></td>
                    </tr>
                </table>
                <table style='width:100%;' class="intro-table">    
                    <tr>
