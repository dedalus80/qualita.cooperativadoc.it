...
for ($k = 1; $k <= count($model->campiSezioni); $k++) {
    ?>
    <page pageset=""  class="" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm" id="modello" > 
        <page_header>
        ...
        <table style='width:100%;' class="" style="border: 1px solid">
            <tr>
            ...
            <tr>
                <td class='intro-big' colspan='2' style="padding: 30px 0px ; width: 100% ">Verifica Ispettiva Settore Sicurezza</td>
            </tr>
        </table>
        <table style='width:100%;' class="intro-table">    
            ...
            <tr>
                ...
                <td class='intro-right' >Inizio Ore :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Fine Ore : </td>
            </tr>
            <tr>
        ...
        <table style='width:100%; margin-top: 15px;'  cellspacing="0" cellpadding="0">
            ...
            <page pageset=""  class="" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm" > 
                ...
                <tr class="row-border">
                    ...
                    <td class='intestazione-valutazione <?= $bg ?>' ></td>
                    <td class='intestazione-note <?= $bg ?>' ></td>
                </tr>
            <?php } ?>
            <tr class="row-border">
                <td class=' <?= $x % 2 == '0' ? "" : "odd" ?>' >Note</td>
                <td colspan="2" class=' <?= $x % 2 == '0' ? "" : "odd" ?>' ></td>
            </tr>
            <tr class="row-border">
                <td   class="<?= $x % 2 == '0' ? "odd" : "" ?>" >Osservazioni del Gestore ed eventuali<br /> Azioni Correttive adottate/adottabili:</td>
                <td class="<?= $x % 2 == '0' ? "odd" : "" ?>" colspan="2" ></td>
            </tr>
        </table>
    </page>
<?php } ?>
