<?php
$this->breadcrumbs = array('Preiscizioni Campus San Paolo' => array('admin'), 'Gestisci',);
...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
		<h2><i class='fa fa-book campuS'></i>&nbsp;<span class='hidden-480'>Preiscrizioni </span>Campus San Paolo</h2>
				...
				array(
                    ...
                    'buttons' => array
                        ...
                        'scarica' => array
                            ...
                            'url' => 'Yii::app()->createUrl("caPreiscrizioni/view", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("caPreiscrizioni/update", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"ca-preiscrizione" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
