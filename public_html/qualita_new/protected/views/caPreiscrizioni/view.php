<?php $this->breadcrumbs = array('Richieste online Campus San Paolo' => array('admin'), 'Gestisci',); ?>
<div class="panel panel-default panel-margin" style="margin-bottom: 300px">
    <div class="panel-heading"><h2><i class='fa fa-book campuS'></i>Richiesta online &nbsp;<span class='orange return-block'><?= $model->nome." ".$model->cognome ?></span></h2></div>
    <div class="panel-body" style='line-height: 50px'>
        ...
        <div class="row ">
			...
			<div class="col-xs-6 col-md-3">
                Facoltà:&nbsp;&nbsp;<span class='bold'><?= $model->getFacolta() ?></span>
            </div>
        </div>
        <div class="row " >
            <div class="col-xs-6 col-md-3">
