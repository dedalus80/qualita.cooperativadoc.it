...
<div>
    ...
    <div class="row row-10 row-bottom">
        ...
        <div class="col-xs-12 col-md-4">
            <label for="" class="c ontrol-label"><?php echo $form->labelEx($model, 'id_medico'); ?></label>
            <? echo $form->dropDownList($model, "id_medico", $model->selectMedici, array('empty' => 'Scegli', 'class' => 'form-control')); ?>
        </div>
        <div class="col-xs-12 col-md-4">
            <label for="" class="c ontrol-label"><?php echo $form->labelEx($model, 'id_responsabile'); ?></label>
            <? echo $form->dropDownList($model, "id_responsabile", $model->selectResponsabili, array('empty' => 'Scegli', 'class' => 'form-control')); ?>
        </div>
    </div>
