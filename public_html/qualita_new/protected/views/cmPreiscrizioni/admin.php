<?php
$this->breadcrumbs = array('Preiscizioni facciamo l\'albero' => array('admin'), 'Gestisci',);
...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-book scuolaNatura'></i><span class='no-phone'>&nbsp;Preiscrizioni</span> Facciamo l'albero</h2>
                  ...
                  'class' => 'CButtonColumn',
                    ...
                    'buttons' => array
                        ...
                        'scarica' => array
                            ...
                            'url' => 'Yii::app()->createUrl("cmPreiscrizioni/update", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"cm-preiscrizione" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
