...
<?php
$this->breadcrumbs = array('Azioni correttive' => array('admin'), 'Indicatori per strutture',);
?>
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading"><h2><i class='fa fa-thumbs-o-up'></i>&nbsp;Indicatori <span class="hidden-480">azioni correttive </span><span class="only-480">ac </span>per strutture</h2></div>
