...
<?php
$this->breadcrumbs = array('Azioni non conformi' => array('admin'), 'Indicatori per tipologia',);
?>
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading"><h2><i class='fa fa-thumbs-o-down'></i>&nbsp;Indicatori <span class='hidden-480'>non conformita </span><span class="only-480">nc </span>per tipologia</h2></div>
        ...
        <table class="table table-striped table-bordered dataTable table-right"  >
             <thead>
                <tr>
                    ...
                    <th style="min-width: 130px" class="no-phone no-tablet">% Chiuse</th>
                    <th style="min-width: 130px" class="no-phone no-tablet">% C. Positive</th>
                    <th style="min-width: 130px" class="no-phone no-tablet">% C. Negative</th>
                </tr>
            </thead>
            <tbody>
