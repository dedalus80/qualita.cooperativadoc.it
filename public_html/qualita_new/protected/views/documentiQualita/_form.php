...
<div class="panel-body">
	...
	<div class="row row-10">
		<div class="col-xs-6">
			...
			<?php echo $form->dropDownList($model,'procedura_id', CHtml::listData(DocumentiQualitaProcedura::model()->findAll(),'id','procedura'), array('empty'=>'Seleziona procedura','class' =>'form-control', 'options' => $selectedProcedura)); ?>
	...
	<div class="row row-10">
		<div class="col-xs-6">
			...
			<?php echo $form->dropDownList($model,'sgq', DocumentiQualita::getSgq(), array('empty'=>'Seleziona Sgq','class' =>'form-control')); ?>
	...
	<div class="row row-10">
		<div class="col-xs-6">
			...
			<?php echo $form->dropDownList($model,'tipologia', DocumentiQualita::getTipologia(), array('empty'=>'Seleziona tipologia','class' =>'form-control')); ?>
	...
	<div class="row row-10">
		<div class="col-xs-6">
			...
			<?php echo $form->dropDownList($model,'codice', DocumentiQualita::getCodice(), array('empty'=>'Seleziona Codice','class' =>'form-control')); ?>
	...
	<div class="row row-10">
		<div class="col-xs-6">
			...
			<?php echo $form->dropDownList($model,'formato', DocumentiQualita::getFormato(), array('empty'=>'Seleziona Formato','class' =>'form-control')); ?>
