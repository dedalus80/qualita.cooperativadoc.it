...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<div class="col-xs-8"><?php echo $form->dropDownList($model,'procedura_id', CHtml::listData(DocumentiQualitaProcedura::model()->findAll(),'id','procedura'), array('empty'=>'Seleziona procedura','class' =>'form-control', 'options' => $selectedProcedura)); ?></div>
	</div>

	<div class="form-group">
		<label class="col-xs-3 control-label"><?php echo $form->labelEx($model,'sgq'); ?></label>
		<div class="col-xs-8"><?php echo $form->dropDownList($model,'sgq', DocumentiQualita::getSgq(), array('empty'=>'Seleziona Sgq','class' =>'form-control')); ?></div>
	</div>

	<div class="form-group">
		<label class="col-xs-3 control-label"><?php echo $form->labelEx($model,'tipologia'); ?></label>
		<div class="col-xs-8"><?php echo $form->dropDownList($model,'tipologia', DocumentiQualita::getTipologia(), array('empty'=>'Seleziona tipologia','class' =>'form-control')); ?></div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-xs-8"><?php echo $form->dropDownList($model,'formato', DocumentiQualita::getFormato(), array('empty'=>'Seleziona Formato','class' =>'form-control')); ?>
	</div>
	</div>
