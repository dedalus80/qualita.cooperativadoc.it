<?php $this->breadcrumbs = array('Richieste online Cascina Fossata' => array('admin'), 'Gestisci',); ?>
<div class="panel panel-default panel-margin" style="margin-bottom: 300px">
    <div class="panel-heading"><h2><i class='fa fa-book cascinaF'></i>Richiesta online &nbsp;<span class='orange return-block'><?= $model->nome." ".$model->cognome ?></span></h2></div>
    <div class="panel-body" style='line-height: 50px'>
        <div class="row ">
            <div class="col-xs-12">
                Provenienza:&nbsp;&nbsp;<span class='bold'><?= $model->refer =='S' ? "Cascina Fossata":"Politecnico" ?></span>
            </div>
        </div>
        <div class="row ">
            <div class="col-xs-12">
                Formula abitativa:&nbsp;&nbsp;<span class='bold'><?= $model->getDettaglioFormula($model->formula, $model->campus) ?></span>
            </div>
        </div>
        <div class="row ">
        ...
        <div class="row ">
            ...
            <div class="col-xs-6 col-md-3">
                Conosciuti tramite:&nbsp;&nbsp;<span class='bold'><?= Yii::app()->MyUtils->getSelectValue($model->conoscenza,'doc_conoscenza') ?></span>
            </div>
            <div class="col-xs-6 col-md-3">
