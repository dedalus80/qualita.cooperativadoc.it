...
$this->breadcrumbs = array(
    html_entity_decode('Tipologie corsi formazione', ENT_QUOTES, 'UTF-8') => array('admin'),
    'Gestione',
);
...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-graduation-cap'></i>&nbsp;Corsi formazione </h2> 
    ...
    <div class="panel-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'emptyText' => 'Non sono presenti categorie corsi formazione',
            'pager' => array(
                'pageSize' => 2,
                'header' => '',
            ...
            'columns' => array(
                ...
                'nome',
                 array(
                    'name' => 'id_categoria',
                    'value' => array($model, 'getCategoria'),
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("FormazioneCorsi/update", array("id"=>$data->id))',
                            'options' => array('class' => 'mycbv dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip','data-html' =>'true', 'title' => Yii::t('app', 'Modifica tipologia <br> corso')),
                            'imageUrl' => false,
                        ),
                    ),
                ),
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => '$data->id',
                            'visible' => 'true',
                            'options' => array('class' => 'del_btn dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip','data-html' =>'true', 'title' => Yii::t('app', 'Elimina tipologia <br> corso formazione')),
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"formazioneCorso" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
