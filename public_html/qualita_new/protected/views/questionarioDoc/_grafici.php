...
foreach($giudizzi as $giudizzio){  
    ...
    if( $model->stats[$giudizzio]['totale'] > 0 ){ 
        $struttura ? $GRAFICO = "grafici/PNG/questionari_doc/strutture/".$struttura."_".$anno."_".$giudizzio.".png" : $GRAFICO = "grafici/PNG/questionari_doc/generali/".$anno."_".$giudizzio.".png";
?>
...
$struttura ? $GRAFICO = "grafici/PNG/questionari_doc/strutture/".$struttura."_".$anno."_consiglia.png" : $GRAFICO = "grafici/PNG/questionari_doc/generali/".$anno."_consiglia.png";
