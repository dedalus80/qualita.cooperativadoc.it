<?php
$this->breadcrumbs = array('Questionari genitori vacanze studio' => array('admin'), 'Gestione',);
Yii::app()->clientScript->registerScript('search', " $('.search-button').click(function(){	$('.search-form').toggle();	return false;});");
?>
<div class="panel panel-default panel-margin">
    <div class="panel-heading">
        <h2><i class='fa fa-question'></i>&nbsp; Questionari Genitori vacanze studio</h2>
    ...
    <div class="panel-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'id' => 'questionario-genitori-studio-grid',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'scarica' => array
                            ...
                            'url' => 'Yii::app()->createUrl("questionarioGenitoriStudio/view", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"questionario_genitori_studio" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
