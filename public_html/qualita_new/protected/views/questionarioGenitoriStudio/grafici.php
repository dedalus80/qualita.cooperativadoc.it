<?php
$this->breadcrumbs = array('Questionari Genitori Vacanze studio' => array('index'), 'statistiche',);
?>
<div class="row">
    <div class="panel panel-default panel-margin" style="">
        <div class="panel-heading">
            <h2><i class='fa fa-bar-chart-o'></i>&nbsp;sTATISTICHE QUESTIONARI  <span class='orange return-block'>GENITORI VACANZE STUDIO <?= $model->struttura ?> <?= $model->turno ? $model->turno." Turno":"" ?> </span> TOTALE QUESTIONARI <span class='orange return-block'> <?= $model->stats['totale'] ?></span></h2>
        ...
        <div class="panel-body" id="stats">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-2"  >
                    <?php echo CHtml::link('<i class="fa fa-refresh"></i><span class="hidden-480">&nbsp;&nbsp;Aggiorna', '#', array('class' => 'btn btn-default btn-md btn-update-stats', 'id' => 'stats-genitori-studio-btn')); ?>
                </div>
            </div>
