...
foreach($giudizzi as $giudizzio){  
    ...
    if( $model->stats[$giudizzio]['totale'] > 0 ){ 
        ...
        $struttura ? $GRAFICO = "grafici/PNG/questionari_junior/strutture/".$struttura."_".$anno."_".$giudizzio.".png" : $GRAFICO = "grafici/PNG/questionari_junior/generali/".$anno."_".$giudizzio.".png";
?>
        ...
        <tr>
            <td class='intro-big' style="text-align: center; width: 100%">
                <span class='titolo-grafici-small'>
                    <?= "<span class='anno-grafici'> ".$nome."</span> Questionari Junior  <span class='anno-grafici'> ".$anno."</span> <span class='totale-grafici'>".$TOT."</span>" ?>
