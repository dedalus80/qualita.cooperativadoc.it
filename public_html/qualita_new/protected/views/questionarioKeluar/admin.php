<?php
$this->breadcrumbs = array('Questionari Keluar' => array('admin'), 'Gestisci',);
...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-question'></i>&nbsp; Questionari Keluar</h2>
            ...
            'columns' => array(
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'scarica' => array
                            ...
                            'url' => 'Yii::app()->createUrl("questionarioKeluar/view", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        (
                        'tmp' => array(
                            'label' => '<i class="ace-icon fa fa-trash-o bigger-110 icon-only btn  btn-circle circle-bluey"></i>',
                            'url' => '$data->id',
                            'visible' => 'true',
                            'options' => array('class' => 'del_btn dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Elimina questionario')),
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"questionario_keluar" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
