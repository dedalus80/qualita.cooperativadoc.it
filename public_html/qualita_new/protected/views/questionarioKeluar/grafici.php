        ...
        Yii::app()->clientScript->registerScript('grafico_'.$giudizzio, "
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    success: function (result) {  console.log('grafico_".$giudizzio." saved') }
                }); 
            })"
        );
    }
    ...
    Yii::app()->clientScript->registerScript('consiglia', "
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    success: function (result) {  console.log('consiglia saved') },
                ...
                <ul class="demo-btns" >
                    ...
                    <?php endif; ?>
                     <li class='li-480' ><?php echo CHtml::link('<i class="fa fa-refresh"></i>', '#', array('class' => 'button-icon button-icon-green', 'id' => 'stats-keluar-btn', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Aggiorna dati'))); ?></li>
                      <li class='li-480' ><a href='#' id='stampa-grafici-btn' data-model='questionarioKeluar' class='button-icon button-icon-green' ><i class='fa fa-download'></i></a> </li>
                    ...
                    <input type='hidden' id='struttura-utente' name='struttura-utente' value='<?= $model->stats['struttura'] ?>' />
                     ...
                     <input type='hidden' id='tipo-grafico' name='tipo-grafico' value='questionari_keluar' />
