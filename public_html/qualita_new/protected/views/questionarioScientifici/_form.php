...
Morris.Donut({
 ...
 $(document).ready(function(){
Morris.Donut({
                    element: 'gra-scientifici_formazione',
                    data: [" . implode(",", $model->stats['scientifici_formazione']) . "],
                    colors: [Utility.getBrandColor('danger'),Utility.getBrandColor('warning'),Utility.getBrandColor('success') ]
                });
 ...
 $(document).ready(function(){
Morris.Donut({
                    element: 'gra-scientifici_didattica',
                    data: [" . implode(",", $model->stats['scientifici_didattica']) . "],
                    colors: [Utility.getBrandColor('danger'),Utility.getBrandColor('warning'),Utility.getBrandColor('success') ]
                });
 ...
 $(document).ready(function(){
Morris.Donut({
                    element: 'gra-scientifici_organizzazione',
                    data: [" . implode(",", $model->stats['scientifici_organizzazione']) . "],
                    colors: [Utility.getBrandColor('danger'),Utility.getBrandColor('warning'),Utility.getBrandColor('success') ]
                });
...
<div style="display: <?= $model->stats['totale'] > 0 ? "block" : "none" ?>" id="table-grafici"> 
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-3" style="display: <?= $model->stats['exist']['scientifici_organizzazione'] > 0 ? "block" : "none" ?>" > 
            <div id="gra-scientifici_organizzazione"></div>
            <table  class="table  table-bordered dataTable">
                <thead><tr><td colspan="3" class="centered nob-right">Organizzazione corsi</td></tr></thead>
                <tbody>
                    <? for ($x = 0; $x < count($model->stats['scientifici_organizzazione_data']); $x++) { ?>
                        <tr><td ><?= $model->stats['scientifici_organizzazione_data'][$x]['label'] ?></td><td class='right'><?= $model->stats['scientifici_organizzazione_data'][$x]['valore'] ?></td><td class='right' ><?= $model->stats['scientifici_organizzazione_data'][$x]['percentuale'] ?> %</td></tr>
                    <? } ?>
                </tbody>
            </table>
            <div class="graf-label" ></div>
        </div>
        <div class="col-xs-12 col-sm-3" style="display: <?= $model->stats['exist']['scientifici_didattica'] > 0 ? "block" : "none" ?>" > 
            <div id="gra-scientifici_didattica"></div>
            <table  class="table  table-bordered dataTable">
                <thead><tr><td colspan="3" class="centered nob-right">didattica corsi</td></tr></thead>
                <tbody>
                    <? for ($x = 0; $x < count($model->stats['scientifici_didattica_data']); $x++) { ?>
                        <tr><td ><?= $model->stats['scientifici_didattica_data'][$x]['label'] ?></td><td class='right'><?= $model->stats['scientifici_didattica_data'][$x]['valore'] ?></td><td class='right' ><?= $model->stats['scientifici_didattica_data'][$x]['percentuale'] ?> %</td></tr>
                    <? } ?>
                </tbody>
            </table>
        </div>
        <div class="col-xs-12 col-sm-3" style="display: <?= $model->stats['exist']['scientifici_formazione'] > 0 ? "block" : "none" ?>" > 
            <div id="gra-scientifici_formazione"></div>
            <table  class="table  table-bordered dataTable">
                <thead><tr><td colspan="3" class="centered nob-right">Utilit&agrave; formazione</td></tr></thead>
                <tbody>
                    <? for ($x = 0; $x < count($model->stats['scientifici_formazione_data']); $x++) { ?>
                        <tr><td ><?= $model->stats['scientifici_formazione_data'][$x]['label'] ?></td><td class='right'><?= $model->stats['scientifici_formazione_data'][$x]['valore'] ?></td><td class='right' ><?= $model->stats['scientifici_formazione_data'][$x]['percentuale'] ?> %</td></tr>
                    <? } ?>
                </tbody>
            </table>
        </div>
