<?php
$this->breadcrumbs = array('Questionari Campus formativi' => array('admin'), 'Gestione',);
Yii::app()->clientScript->registerScript('search', " $('.search-button').click(function(){	$('.search-form').toggle();	return false;});");
?>
<div class="panel panel-default panel-margin">
    <div class="panel-heading">
		<h2><i class='fa fa-question'></i>&nbsp; Questionari <span class='hidden-480'>Campus </span>formativii </h2>
                 ...
                 array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("questionarioScientifici/update", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'scarica' => array
                            ...
                            'url' => 'Yii::app()->createUrl("questionarioScientifici/view", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"questionario_scientifici" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
