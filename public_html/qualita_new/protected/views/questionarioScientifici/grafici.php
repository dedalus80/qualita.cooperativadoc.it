<?php
$this->breadcrumbs = array('Questionari Campus Formativi' => array('index'), 'statistiche',);
        ...
        <div class="panel-heading">
            ...
            <div class="panel-ctrls">
                <ul class="demo-btns" >
                    ...
                    <?php endif; ?>
                    <li class='li-480' ><?php echo CHtml::link('<i class="fa fa-refresh"></i>', '#', array('data-model' =>'Scientifici' , 'class' => 'button-icon button-icon-green', 'id' => 'btn-update-stats', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Aggiorna dati'))); ?></li>
                    <li class='li-480' ><a href='#' id='stampa-grafici-btn' data-model='questionarioScientifici' class='button-icon button-icon-green' ><i class='fa fa-download'></i></a> </li>
                    ...
                    <input type='hidden' id='tipo-grafico' name='tipo-grafico' value='questionari_scientifici' />
                </ul>
            </div>
        </div>
