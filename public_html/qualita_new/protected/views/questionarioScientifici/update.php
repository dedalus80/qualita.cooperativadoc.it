<?php
$this->breadcrumbs = array('Questionari formativi' => array('admin'), 'Modifica questionario',);
?>
<div class="panel panel-default panel-margin ">
    ...
    <div class="panel-body ">
        <?php
        $form = $this->beginWidget('CActiveForm', array('id' => 'questionarioScientifici-form', 'enableAjaxValidation' => true, 'htmlOptions' => array('enctype' => 'multipart/form-data'),
        ...
        <div>
            ...
            <div class="question-body" style='margin-top: 20px;'>
                ...
                <div class="row ">
                    ...
                    <div class="col-xs-12  col-sm-6 right"><span id="rgv8"><?php echo $form->radioButtonList($model, 'scientifici_organizzazione', array('M' => '', 'A' => '', 'P' => ""), array('labelOptions' => array('style' => 'display:inline'), 'class' => 'radio-suf', 'separator' => '&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;')); ?></span></div>
                </div>
                <div class="row ">
                    <div class="col-xs-12 col-sm-6"> <span class='bold'><?= $form->labelEx($model, 'scientifici_didattica'); ?></span></div>
                    <div class="col-xs-12  col-sm-6 right"><span id="rgv9"><?php echo $form->radioButtonList($model, 'scientifici_didattica', array('M' => '', 'A' => '', 'P' => ""), array('labelOptions' => array('style' => 'display:inline'), 'class' => 'radio-suf', 'separator' => '&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;')); ?></span></div>
                </div>
                <div class="row ">
                    <div class="col-xs-12 col-sm-6"> <span class='bold'><?= $form->labelEx($model, 'scientifici_formazione'); ?></span></div>
                    <div class="col-xs-12  col-sm-6 right"><span id="rgv10"><?php echo $form->radioButtonList($model, 'scientifici_formazione', array('M' => '', 'A' => '', 'P' => ""), array('labelOptions' => array('style' => 'display:inline'), 'class' => 'radio-suf', 'separator' => '&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;')); ?></span></div>
                </div>
                <div class="row ">
                    <div class="col-xs-12">
        ...
        <div class="panel-footer">
            <div class="pull-right">
                <?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange btn-sm ', 'id' => 'questionarioScientifici-btn')); ?>
            </div>
        </div>
        <?php $this->endWidget(); ?>
    </div>
