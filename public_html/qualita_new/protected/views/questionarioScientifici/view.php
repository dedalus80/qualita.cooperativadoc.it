...
$this->breadcrumbs = array(
    'Questionario Campus formativi' => array('index'),
...
<div class="panel panel-default panel-margin">
    <div class="panel-heading">
        <h2><i class='fa fa-question'></i>&nbsp; Questionario campus formativi <span class='orange return-block'><?= $model->nome_coordinatore . " " . $model->cognome_coordinatore ?></h2>
    ...
    <div class="panel-body question-body">
        ...
        <div class="row ">
            <div class="col-xs-12 col-sm-6"> <span class='bold'><?= $form->labelEx($model, 'scientifici_organizzazione'); ?></span></div>
            <div class="col-xs-2 centered"><?= $model->scientifici_organizzazione == 'M' ? "<img src='" . Yii::app()->request->baseUrl . "/images/ottimo.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->scientifici_organizzazione == 'A' ? "<img src='" . Yii::app()->request->baseUrl . "/images/sufficente.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->scientifici_organizzazione == 'P' ? "<img src='" . Yii::app()->request->baseUrl . "/images/insufficente.png '>" : "" ?></div>
            
        </div>
        <div class="row ">
            <div class="col-xs-12 col-sm-6"> <span class='bold'><?= $form->labelEx($model, 'scientifici_didattica'); ?></span></div>
            <div class="col-xs-2 centered"><?= $model->scientifici_didattica == 'M' ? "<img src='" . Yii::app()->request->baseUrl . "/images/ottimo.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->scientifici_didattica == 'A' ? "<img src='" . Yii::app()->request->baseUrl . "/images/sufficente.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->scientifici_didattica == 'P' ? "<img src='" . Yii::app()->request->baseUrl . "/images/insufficente.png '>" : "" ?></div>
            
        </div>
        <div class="row ">
            <div class="col-xs-12 col-sm-6"> <span class='bold'><?= $form->labelEx($model, 'scientifici_formazione'); ?></span></div>
            <div class="col-xs-2 centered"><?= $model->scientifici_formazione == 'M' ? "<img src='" . Yii::app()->request->baseUrl . "/images/ottimo.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->scientifici_formazione == 'A' ? "<img src='" . Yii::app()->request->baseUrl . "/images/sufficente.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->scientifici_formazione == 'P' ? "<img src='" . Yii::app()->request->baseUrl . "/images/insufficente.png '>" : "" ?></div>
        </div>
          <div class="row title">
            <div class="col-xs-12">
