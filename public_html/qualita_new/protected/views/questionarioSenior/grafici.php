<?php
$this->breadcrumbs = array('Questionari Senior' => array('index'), 'statistiche',);
$tmp = Yii::app()->MyUtils->getDatiQuestionario("questionario_senior");
        ...
        <div class="panel-heading">
            ...
            <div class="panel-ctrls">
                <ul class="demo-btns" >
                    ...
                    <?php endif; ?>
                     <li class='li-480' ><?php echo CHtml::link('<i class="fa fa-refresh"></i>', '#', array('class' => 'button-icon button-icon-green ','data-model' => 'Senior',  'id' => 'btn-update-stats', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Aggiorna dati'))); ?></li>
                    <li class='li-480' ><a href='#' id='stampa-grafici-btn' data-model='questionarioSenior' class='button-icon button-icon-green' ><i class='fa fa-download'></i></a> </li>
                    ...
                    <input type='hidden' id='struttura-utente' name='struttura-utente' value='<?= $model->stats['struttura'] ?>' />
                     ...
                     <input type='hidden' id='tipo-grafico' name='tipo-grafico' value='questionari_senior' />
                </ul>
            </div>
        </div>
