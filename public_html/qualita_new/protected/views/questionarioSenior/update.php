<?php
$this->breadcrumbs = array('Questionari Senior' => array('admin'), 'Modifica questionario',);
?>
<div class="panel panel-default panel-margin ">
    ...
    <div class="panel-body ">
        <?php
        $form = $this->beginWidget('CActiveForm', array('id' => 'questionarioSenior-form', 'enableAjaxValidation' => true, 'htmlOptions' => array('enctype' => 'multipart/form-data'),
        ...
        <div class="panel-footer">
            <div class="pull-right">
                <?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange btn-sm ', 'id' => 'questionarioSenior-btn')); ?>
            </div>
        </div>
        <?php $this->endWidget(); ?>
    </div>
