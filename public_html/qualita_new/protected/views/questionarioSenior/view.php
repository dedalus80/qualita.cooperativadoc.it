...
$this->breadcrumbs = array(
    'Questionario Senior' => array('index'),
...
<div class="panel panel-default panel-margin">
    <div class="panel-heading">
        <h2><i class='fa fa-question'></i>&nbsp; Questionario Senior <span class='orange return-block'><?= $model->nome . " " . $model->cognome ?></h2>
    ...
    <div class="panel-body question-body">
        <div id="detail">
            <div class="row "> 
                ...
                <div class="col-xs-6 col-sm-4">
                    <?= $form->labelEx($model, 'eta'); ?>:&nbsp;&nbsp;<span class='bold'><?= $model->eta; ?></span>
                </div>
            </div>
            <div class="row "> 
                <div class="col-xs-6 col-sm-4">
