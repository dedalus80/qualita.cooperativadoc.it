<?php
$this->breadcrumbs = array('Questionari Vacanze Studio' => array('index'), 'statistiche',);
$tmp = Yii::app()->MyUtils->getDatiQuestionario("questionario_studio");
...
<div class="row">
    <div class="panel panel-default panel-margin" style="">
        <div class="panel-heading">
            <h2><i class='fa fa-bar-chart-o'></i>&nbsp;<span class='hidden-480'>STATISTICHE </span><span class='orange' style='font-weight: 550'>
                    <?= $model->stats['nome_struttura'] ?></span> Totale questionari <span class='orange' style='font-weight: 550'>
                    <?= $model->stats['totale'] ?></span></h2>
            <div class="panel-ctrls">
                <ul class="demo-btns">
                    ...
                    <li class='li-480'>
                        <div class="input-group date" style="margin-bottom:-5px !important">
                            ...
                            <select id="struttura" name="struttura" class="form-control">
                                ...
                                <option value="<?= $id ?>" <?=$model->stats['struttura'] == $id ? "selected='selected'" : "" ?> >
                                    <?= $val ?>
                                </option>
                                <? } ?>
                            </select>
                    ...
                    <?php endif; ?>
                    <li class='li-480'>
                        <?php echo CHtml::link('<i class="fa fa-refresh"></i>', '#', array('data-model' => 'Studio' , 'class' => 'button-icon button-icon-green', 'id' => 'btn-update-stats', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Aggiorna dati'))); ?>
                    </li>
                    <li class='li-480' ><a href='#' id='stampa-grafici-btn' data-model='questionarioStudio' class='button-icon button-icon-green' ><i class='fa fa-download'></i></a> </li>
                    ...
                    <input type='hidden' id='tipo-grafico' name='tipo-grafico' value='questionari_studio' />
                </ul>
            </div>
        </div>
