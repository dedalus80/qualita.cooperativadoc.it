...
$this->breadcrumbs = array(
    'Questionario Vacanze studio' => array('index'),
...
<div class="panel panel-default panel-margin">
    <div class="panel-heading">
        <h2><i class='fa fa-question'></i>&nbsp; Questionario Vacanze studio <span class='orange return-block'><?= $model->nome_coordinatore . " " . $model->cognome_coordinatore ?></span></h2>
    ...
    <div class="panel-body question-body">
        ...
        <div class="row ">
            ...
            <div class="col-xs-2 centered"><?= $model->studio_localita == 'M' ? "<img src='" . Yii::app()->request->baseUrl . "/images/ottimo.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->studio_localita == 'A' ? "<img src='" . Yii::app()->request->baseUrl . "/images/sufficente.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->studio_localita == 'P' ? "<img src='" . Yii::app()->request->baseUrl . "/images/insufficente.png '>" : "" ?></div>
            
        </div>
        <div class="row ">
            <div class="col-xs-12 col-sm-6"> <span class='bold'><?= $form->labelEx($model, 'studio_college'); ?></span></div>
            <div class="col-xs-2 centered"><?= $model->studio_college == 'M' ? "<img src='" . Yii::app()->request->baseUrl . "/images/ottimo.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->studio_college == 'A' ? "<img src='" . Yii::app()->request->baseUrl . "/images/sufficente.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->studio_college == 'P' ? "<img src='" . Yii::app()->request->baseUrl . "/images/insufficente.png '>" : "" ?></div>
            
        </div>

        <div class="row ">
            <div class="col-xs-12 col-sm-6"> <span class='bold'><?= $form->labelEx($model, 'studio_corso'); ?></span></div>
            <div class="col-xs-2 centered"><?= $model->studio_corso == 'M' ? "<img src='" . Yii::app()->request->baseUrl . "/images/ottimo.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->studio_corso == 'A' ? "<img src='" . Yii::app()->request->baseUrl . "/images/sufficente.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->studio_corso == 'P' ? "<img src='" . Yii::app()->request->baseUrl . "/images/insufficente.png '>" : "" ?></div>
        </div>
        <div class="row ">
            <div class="col-xs-12 col-sm-6"> <span class='bold'><?= $form->labelEx($model, 'studio_aspetto_vacanza'); ?></span></div>
            <div class="col-xs-12 col-sm-6"><?= $model->studio_aspetto_vacanza ? strtoupper(substr($model->studio_aspetto_vacanza, 0,1)).strtolower(substr($model->studio_aspetto_vacanza, 1))    :"<br />" ?></div>

        </div>
        <div class="row ">
            <div class="col-xs-12 col-sm-6"> <span class='bold'><?= $form->labelEx($model, 'studio_attivita_utile'); ?></span></div>
            <div class="col-xs-12 col-sm-6"><?= $model->studio_attivita_utile ? strtoupper(substr($model->studio_attivita_utile, 0,1)).strtolower(substr($model->studio_attivita_utile, 1))    :"<br />" ?></div>
