...
$this->breadcrumbs = array(
    'Questionario Torre Marina' => array('index'),
    $model->id,
);
?>
...
<div class="panel panel-default panel-margin">
    <div class="panel-heading">
        <h2><i class='fa fa-question'></i>&nbsp; Questionario Torremarina <span class='orange return-block'><?= $model->nome . " " . $model->cognome ?></h2>
    ...
    <div class="panel-body question-body">
        ...
        <div class="row ">
            ...
            <div class="col-xs-2 centered"><?= $model->vacanza == 'I' ? "<input type='radio' class='radio-ins' checked='checked'  />" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->vacanza == 'S' ? "<img src='".Yii::app()->request->baseUrl."/images/sufficente.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->vacanza == 'B' ? "<input type='radio' class='radio-buo' checked='checked'/>" : "" ?></div>
        ...
        <div class="row ">
            <div class="col-xs-4"> <span class='bold'><?= $form->labelEx($model, 'personale_animazione'); ?></span></div>
            <div class="col-xs-2 centered"><?= $model->personale_animazione == 'I' ? "<img src='".Yii::app()->request->baseUrl."/images/insufficente.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->personale_animazione == 'S' ? "<img src='".Yii::app()->request->baseUrl."/images/sufficente.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->personale_animazione == 'B' ? "<img src='".Yii::app()->request->baseUrl."/images/buono.png '>" : "" ?></div>
            <div class="col-xs-2 centered"><?= $model->personale_animazione == 'E' ? "<img src='".Yii::app()->request->baseUrl."/images/ottimo.png '>" : "" ?></div>
        </div>
        <div class="row ">
