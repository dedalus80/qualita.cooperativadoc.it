<?php
$form = $this->beginWidget('CActiveForm', array('id' => 'responsabili-form', 'enableAjaxValidation' => true, 'htmlOptions' => array('enctype' => 'multipart/form-data', 'class' => 'form-orizontal'),'clientOptions' => array(  'validateOnSubmit' => true, ),  ));
?>
<div>
...
<div class="panel-footer">
    <div class="pull-right">
        <?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange btn-submit-form', 'data-refer' => 'responsabili-form')); ?>
    </div>
</div>
<?php $this->endWidget(); ?>