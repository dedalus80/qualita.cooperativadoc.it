<?php
$form = $this->beginWidget('CActiveForm', array('id' => 'sh-preiscrizioni-form', 'enableAjaxValidation' => true, 'htmlOptions' => array('enctype' => 'multipart/form-data'),
    ...
    <fieldset style="margin-top: 20px ">
        ...
        <div class="row row-10 " >
            ...
            <div class="col-xs-12 col-md-4">
                <label for="" class="control-label label-no-margin"><?php echo $form->labelEx($model, 'formula'); ?></label>
                <?php 
                    echo $form->dropDownList(
                        ...
                        //$model->selectFormule,
                        CHtml::listData(
                            Formule::model()->findAllByAttributes(
                                ['form_sh' => 'Y', 'show_on_q' => 'Y'],
                                array('order'=>'nome')
                            ),
                            'id',
                            'nome'
                        ...
                        array(
                            ...
                            'options' => $sel, 
                            'class' => 'form-control', 
                            'onChange' => 'javascript:showFormula()'
                        )
                    ); 
                ?>
            </div>
            <div class="col-xs-12 col-md-4">
                <label for="campus" class="control-label label-no-margin"><?php echo $form->labelEx($model, 'campus'); ?></label>
                <?php 
                    echo $form->dropDownList(
                        $model, 
                        "campus", 
                        CHtml::listData(
                            Campus::model()->findAllByAttributes(
                                ['formulaId' => $model->formula], 
                                array('order'=>'nome')
                            ), 
                            'id', 
                            'nome'
        ...
        <div class="row row-10">
            <div class="col-xs-4 col-md-4">
                <label for="" class="control-label label-no-margin"><?php echo $form->labelEx($model, 'coabitazione'); ?></label>
...
<div class="panel-footer">
    <div class=" pull-right">
        <?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange ', 'id' => 'sh-preiscrizioni-btn')); ?>
    </div>
</div>
<?php $this->endWidget(); ?> 
