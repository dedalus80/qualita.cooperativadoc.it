<?php
$this->breadcrumbs = array('Preiscizioni Sharing' => array('admin'), 'Gestisci',);
...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-book shariNG'></i>&nbsp; Preiscrizioni Sharing</h2>
				...
				array(
                    ...
                    'buttons' => array
                        ...
                        'scarica' => array
                            ...
                            'url' => 'Yii::app()->createUrl("shPreiscrizioni/view", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("shPreiscrizioni/update", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"sh-preiscrizione" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
