<?php
$this->breadcrumbs = array('Iscrizioni convegno' => array('admin'), 'Gestisci',);
...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-book scuolaNatura'></i>&nbsp; Preiscrizioni convegno</h2>
       ...
       <?php
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns' => array(
                ...
                array(
                    'name' => 'focus',
                    'value' => array($model, 'getFocus'),
                    'htmlOptions' => array('class' => 'hidden-480'),
                    'headerHtmlOptions' => array('class' => 'hidden-480'),
                ),
                array(
                    'name' => 'percorso',
                    'value' => array($model, 'getPercorso'),
                    'htmlOptions' => array('class' => 'hidden-480'),
                    'headerHtmlOptions' => array('class' => 'hidden-480'),
                ),
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("snPreiscrizioni/update", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"sn-preiscrizione" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
