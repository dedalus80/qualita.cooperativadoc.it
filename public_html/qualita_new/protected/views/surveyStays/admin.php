<?php
$this->breadcrumbs = array('Questionari Partecipanti' => array('admin'), 'Gestione',);
Yii::app()->clientScript->registerScript('search', " $('.search-button').click(function(){	$('.search-form').toggle();	return false;});");
?>
<div class="panel panel-default panel-margin">
    <div class="panel-heading">
        <h2><i class='fa fa-question'></i>&nbsp; Questionari <?php echo $tipologia->tipologia;?></h2>
        <div class="panel-ctrls">
            <ul class="demo-btns">
                ...
                <li><?php echo CHtml::link('<i class="fa fa-download"></i>', $this->createAbsoluteUrl('survey-stays/download/'.$tipologia->id), array('class' => 'open-search button-icon button-icon-orange', 'rel'=>'tooltip', 'data_toggle'=>'tooltip','title'=> 'Esporta questionari')); ?></li>
            </ul>
        </div>
    </div>
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns' => array(
				...
				array(
                    ...
                    'value' => 'Yii::app()->dateFormatter->format("d-MM-y",strtotime($data->data_restituzione))',// array($model, 'getDataFormated'),
                ...
                /*array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("questionarioJunior/update", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'scarica' => array
                            ...
                            'url' => 'Yii::app()->createUrl("survey-stays", array("view"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"surveystays" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
    ...
    <div class="modal-dialog" style="max-width: 600px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php $this->renderPartial('_search', array('model' => $model, 'centri' => $centri)); ?>   
            </div>
