...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-cogs'></i>&nbsp; Funzioni</h2>
        <div class="panel-ctrls">
            <ul class="demo-btns">
                ...
                <li><?php echo CHtml::link('<i class="fa fa-plus"></i>', './create', array('class' => 'button-icon button-icon-green', 'id' => '', 'rel' => 'tooltip', 'data-html' => 'true', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Aggiungi Funzione'))); ?></li>
            </ul>
        </div>
    </div>
    <div class="panel-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'summaryText' => 'Totale funzioni <span class=\'orange\'>{count}</span> Pagina {page} di {pages}',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("./TimFunzioni/update", array("id"=>$data->id))',
                            'options' => array('class' => 'mycbv dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Modifca funzione')),
                            'imageUrl' => false,
                        ),
                    ),
                ),
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => '$data->id',
                            'visible' => 'true',
                            'options' => array('class' => 'del_btn dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Elimina funzione')),
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"timFunzioni" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
