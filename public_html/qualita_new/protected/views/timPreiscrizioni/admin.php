<?php
$this->breadcrumbs = array('Preiscizioni TIM' => array('admin'), 'Gestisci',);
...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
		<h2><i class='fa fa-book tim'></i>&nbsp;<span class='hidden-480'>Preiscrizioni </span>TIM</h2>
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns' => array(
                ...
                array(
                    ...
                    'value' => array($model, 'getDataIscrizione'),
				...
				array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("timPreiscrizioni/update", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"tim-preiscrizione" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
    ...
    <div class="modal-dialog" style="max-width: 600px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" ><i class='fa fa-book tim'></i>&nbsp;&nbsp;Ricerca iscrizione</h4>
            </div>
