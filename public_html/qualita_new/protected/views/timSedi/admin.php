...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-cogs'></i>&nbsp; Sedi</h2>
        <div class="panel-ctrls">
            <ul class="demo-btns">
                ...
                <li><?php echo CHtml::link('<i class="fa fa-plus"></i>', './create', array('class' => 'button-icon button-icon-green', 'id' => '', 'rel' => 'tooltip', 'data-html' => 'true', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Aggiungi sede'))); ?></li>
            </ul>
        </div>
    </div>
    <div class="panel-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'summaryText' => 'Totale sedi <span class=\'orange\'>{count}</span> Pagina {page} di {pages}',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("./TimSedi/update", array("id"=>$data->id))',
                            'options' => array('class' => 'mycbv dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Modifca sede')),
                            'imageUrl' => false,
                        ),
                    ),
                ),
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => '$data->id',
                            'visible' => 'true',
                            'options' => array('class' => 'del_btn dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Elimina sede')),
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"timSedi" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
    ...
    <div class="modal-dialog" style="max-width: 450px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" ><i class='fa fa-cogs'></i>&nbsp;&nbsp;Ricerca sede</h4>
            </div>
