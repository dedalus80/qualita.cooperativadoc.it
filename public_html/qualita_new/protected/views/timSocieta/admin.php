...
$this->breadcrumbs = array(
    html_entity_decode('Societ&agrave;', ENT_QUOTES, 'UTF-8') => array('admin'),
    'Gestione',
);
...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-cogs'></i>&nbsp; Societ&agrave;</h2>
        <div class="panel-ctrls">
            <ul class="demo-btns">
                ...
                <li><?php echo CHtml::link('<i class="fa fa-plus"></i>', './create', array('class' => 'button-icon button-icon-green', 'id' => '', 'rel' => 'tooltip', 'data-html' => 'true', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Aggiungi societ&agrave;'))); ?></li>
            </ul>
        </div>
    </div>
    <div class="panel-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'summaryText' => 'Totale societ&agrave; <span class=\'orange\'>{count}</span> Pagina {page} di {pages}',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("./TimSocieta/update", array("id"=>$data->id))',
                            'options' => array('class' => 'mycbv dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip','data-html' => 'true', 'title' => Yii::t('app', 'Modifca societ&agrave;')),
                            'imageUrl' => false,
                        ),
                    ),
                ),
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => '$data->id',
                            'visible' => 'true',
                            'options' => array('class' => 'del_btn dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip','data-html' => 'true', 'title' => Yii::t('app', 'Elimina societ&agrave;')),
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"timSocieta" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
    ...
    <div class="modal-dialog" style="max-width: 450px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" ><i class='fa fa-cogs'></i>&nbsp;&nbsp;Ricerca societ&agrave;</h4>
            </div>
