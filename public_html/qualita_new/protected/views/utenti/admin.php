...
<div class="panel panel-default panel-margin panel-480">
    <div class="panel-heading">
        <h2><i class='fa fa-user-circle-o'></i>&nbsp; Utenti <span class='no-phone'>qualit&agrave;</span></h2>
    ...
    <div class="panel-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'summaryText' => 'Totale utenti <span class=\'orange\'>{count}</span> Pagina {page} di {pages}',
            'emptyText' => 'Non ci sono utenti',
            'pager' => array(
                'pageSize' => 2,
                'header' => '',
            ...
            'columns' => array(
                array(
					...
					'type' => 'raw',
                    'headerHtmlOptions' => array('class' => 'td-phone'),
                ),
				array(
                    'name' => 'nome',
                ...
                array(
                    'header' => 'Tag',
                    'type' => 'raw',
                    'value' => array($model, 'getTagsList'),
                    'htmlOptions' => array('class' => 'hidden-480'),
                    'headerHtmlOptions' => array('class' => 'hidden-480'),
                ),
                array(
                    'class' => 'CButtonColumn',
                    'header' => "<span class='no-phone'>Notifiche</span><span class='only-phone'>Alert</span>",
                    ...
                    'buttons' => array
                        (
                        'tmp' => array(
                            'label' => '<i class="ace-icon fa fa-bell-o bigger-110 icon-only btn  btn-circle circle-blue"></i>',
                            'url' => '$data->id',
                            'visible' => 'true',
                            'options' => array('class' => 'del_btn push', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Notifiche questionari')),
                            'click' => 'js: function(e){ addPush($(this).attr("href"),"utente" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("utenti/update", array("id"=>$data->id))',
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => '$data->id',
                            'visible' => 'true',
                            'options' => array('class' => 'del_btn dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Elimina utente')),
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"utente" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
    ...
    <div class="modal-dialog" style="max-width: 400px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" ><i class='fa fa-user-circle-o'></i>&nbsp;&nbsp;Ricerca Utenti</h4>
            </div>
