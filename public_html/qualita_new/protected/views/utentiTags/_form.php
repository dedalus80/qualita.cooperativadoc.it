...
$form = $this->beginWidget('CActiveForm', array(
    ...
    'htmlOptions' => array('enctype' => 'multipart/form-data', 'class' => 'form-orizontal'),
...
<div>
    ...
    <div class="row row-10 row-bottom">
        <div class="col-xs-12 col-md-12">
            ...
            <?php echo $form->textField($model, 'nome', array('class' => 'form-control', 'maxlength' => 100)); ?>
        </div>
    </div>
...
<div class="panel-footer">
    <div class="pull-right">
        <?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange btn-submit-form', 'data-refer' => 'utenti-tag-form')); ?>
    </div>
</div>
