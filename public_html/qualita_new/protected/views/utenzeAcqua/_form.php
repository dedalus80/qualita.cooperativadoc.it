 <?php $form = $this->beginWidget('CActiveForm', array('id' => 'utenze-acqua-form','enableAjaxValidation' => true,'htmlOptions' => array('enctype' => 'multipart/form-data'),
    'clientOptions' => array(
    ...
    <?}else{ ?>
      <div class="row row-10">
            ...
            <div class="col-xs-12 col-md-4">
                ...
                <? echo "Totale: <b>".$model->totale."</b> -  <b>".$model->media."</b> MC/persona" ?>
            </div>
            <div class="col-xs-12 col-md-4">
...
<div class="panel-footer">
    <div class="pull-right">
        <?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange convalida_utenza', 'id' => 'utenze-acqua-btn')); ?>
    </div>
</div>
<?php $this->endWidget(); ?>
