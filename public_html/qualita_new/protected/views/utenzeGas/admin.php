...
<div class="panel panel-default panel-margin">
    ...
    <div class="panel-body">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'emptyText' => 'Non presenti consumi gas per le strutture',
            'pager' => array(
                'pageSize' => 2,
                'header' => '',
            ...
            'columns' => array(
               ...
               array(
                ...
                array(
                 ...
                 array(
                    'name' => 'media_mc_ospiti',
                    'value' => array($model, 'getMcOspiti'),
                    'htmlOptions' => array('class' => 'hidden-480 centered'),
                    'headerHtmlOptions' => array('class' => 'hidden-480 centered dark'),
                ),
                 array(
                    'name' => 'media_mc_superfice',
                    'value' => array($model, 'getMcSuperficie'),
                ...
                array(
                    ...
                    'buttons' => array
                        ...
                        'scarica' => array
                            ...
                            'url' => 'Yii::app()->createUrl("utenzeGas/view", array("id"=>$data->id))',
                            'options' => array('class' => 'myview dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Visualizza consumi gas struttura')),
                        ),
                    ),
                ),
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("utenzeGas/update", array("id"=>$data->id))',
                            'options' => array('class' => 'mycbv dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Modifica consumi gas struttura')),
                            'imageUrl' => false,
                        ),
                    ),
                ),
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => '$data->id',
                            'visible' => 'true',
                            'options' => array('class' => 'del_btn dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Elimina consumi gas struttura')),
                            'click' => 'js: function(e){ delDato($(this).attr("href"),"utenze_gas" ); return false }',
                            'imageUrl' => false,
                        ),
                    ),
                ),
                array(
                    ...
                    'buttons' => array
                        ...
                        'tmp' => array(
                            ...
                            'url' => 'Yii::app()->createUrl("utenzeGas/scarica", array("id"=>$data->id))',
                            'options' => array('class' => 'mycbv dark', 'rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Scarica consumi gas struttura')),
                            'imageUrl' => false,
                        ),
                    ),
                ),
    ...
    <div class="modal-dialog" style="max-width: 600px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" ><i class='fa fa-fire'></i>&nbsp;&nbsp;Ricerca consumi</h4>
            </div>
