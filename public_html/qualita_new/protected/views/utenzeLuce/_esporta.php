...
for ($x = 2; $x <= 27; $x++) {
    if ($x % 2 == 0)
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($x, $row, "KWH");
    else
...
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("29", $row, "KWH");
...
header('Content-Disposition: attachment;filename="Consumi_Energetici.xls"');
