<?php
$form = $this->beginWidget('CActiveForm', array('id' => 'utenze-luce-form', 'enableAjaxValidation' => true, 'htmlOptions' => array('enctype' => 'multipart/form-data'),
    'clientOptions' => array(
...
<div>
        ...
        <div class="row row-10">
            ...
            <div class="col-xs-12 col-md-10">
                ...
                if (Yii::app()->user->getState('group') == 'ADMIN') {
                    ...
                    //echo $form->dropDownList($model, "struttura",  CHtml::listData(Strutture::model()->findAll(['condition' => 'id IN ("'.implode('","', Yii::app()->user->getState('strutture')).'")', 'order'=>'nome']), 'id', 'nome'), array('empty' => 'Scegli', 'options' => $sel, 'class' => 'form-control'));
                    echo "<br>" . Yii::app()->MyUtils->getSelectValue($model->struttura, 'doc_unita');
                    echo $form->hiddenField($model, 'struttura');
                }
                ?>
    ...
    <? } else { ?>
        <div class="row row-10">
            ...
            <div class="col-xs-12 col-md-4">
                <label for="" class="c ontrol-label">Consumi MC</label>
                <? echo "Totale: <b>" . $model->totale . "</b> -  <b>" . $model->media . "</b>  KWH/persona" ?>
            </div>
            <div class="col-xs-12 col-md-4">
                <label for="" class="c ontrol-label">Consumi Euro</label>
                <? echo "Totale: <b>" . $model->c_totale . "</b> - <b>" . $model->c_media . "</b> &euro;/persona" ?>
            </div>
        </div>
    <? } ?>
    <div class="row row-10">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'gennaio', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
        ...
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'febbraio', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
        ...
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'marzo', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
        ...
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'aprile', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
    ...
    <div class="row row-10">
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'maggio', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
        ...
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'giugno', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
        ...
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'luglio', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
        ...
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'agosto', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
    ...
    <div class="row row-10 row-bottom">
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'settembre', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
        ...
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'ottobre', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
        ...
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'novembre', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
        ...
        <div class="col-xs-12 col-md-3">
            ...
            <div class="row">
                <div class='col-xs-6'>
                    <div class="input-group date">
                        <span class="input-group-addon">KWH</span><?php echo $form->textField($model, 'dicembre', array('class' => 'form-control')); ?>
                    </div>
                </div>
                <div class='col-xs-6'> 
                    <div class="input-group date">
...
<div class="panel-footer">
    <div class="pull-right">
        <?php echo CHtml::link($model->isNewRecord ? "<i class='fa fa-edit '></i>&nbsp;Inserisci" : "<i class='fa fa-edit '></i>&nbsp;Aggiorna", '#', array('class' => 'btn btn-orange convalida_utenza', 'id' => 'utenze-luce-btn')); ?>
    </div>
</div>
<?php $this->endWidget(); ?>
