...
$objPHPExcel->getProperties()->setCreator("Cooperativa doc")->setTitle("Consumi Rifiuti");
...
header('Content-Disposition: attachment;filename="Consumi_Rifiuti_' . str_replace(" ", "_", $model->struttura_nome) . '_' . $model->anno . '.xls"');
