...
//~ 	error_reporting(E_ALL ^ E_NOTICE);
	...
	if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
		...
		$campi = array('campi_Doc' => array(
				'obli' => array("albergo", "arrivo", "partenza", "tipologia", "conoscenza"),
...
//~ 			$query = "UPDATE questionario_doc SET 
//~ 				
//~ 		lingua ='" . $qu['language'] . "' , 
//~ 		data_restituzione ='" . $data . "' , 
//~ 		struttura_nome ='" . $qu['albergo'] . "' , 
//~ 		data_arrivo ='" . $arrivo . "' , 
...
//~ 		personale_animazione ='" . $qu['personale_animazione'] . "' , 
...
//~ 		} else {
			...
			$query = "INSERT INTO questionario_doc ( nome, cognome, lingua, email, cellulare, data_arrivo, data_partenza, conoscenza,
						tipologia_cliente, giorni_permanenza,  data_restituzione, vacanza, struttura_pulizia, struttura_nome,
						struttura_complessivo, stanza_confort,  stanza_complessivo, ristorante_servizio, 
						ristorante_cibo, ristorante_complessivo, personale_cortesia, personale_professionalita,
						personale_complessivo, personale_animazione, consiglia, suggerimenti, info, anno) VALUES 
						...
						'" . $qu['struttura_complessivo'] . "', '" . $qu['camera_comfort'] . "', '" . $qu['camera_complessivo'] . "', '" . $qu['ristorante_servizio'] . "',
						'" . $qu['ristorante_qualita'] . "', '" . $qu['ristorante_complessivo'] . "', '" . $qu['personale_cortesia'] . "', '" . $qu['personale_professionalita'] . "',
						'" . $qu['personale_complessivo'] . "', '" . $qu['personale_animazione'] . "', '" . $qu['consiglia'] . "', '" . addslashes($qu['suggerimenti']) . "','" . $qu['info'] . "', '" . date("Y") . "');";
//~ 		}
...
//~ 			$email = "Questionario inserito con successo <br />";
		}
		else {
			$response = [
				'success' => false,
...
//~ 			$email = "Errore inserimento Questionario inserito con successo <br />".$error." <br />";
...
//~ 		$mailC->Subject = "Questionario Doc Scs";
//~ 		$mailC->setFrom('questionario@cooperativadoc.it', 'Questionario Cooperativadoc.it');
//~ 		$mailC->addReplyTo('questionario@cooperativadoc.it', 'Questionario Cooperativadoc.it');
