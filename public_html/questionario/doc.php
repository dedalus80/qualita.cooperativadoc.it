...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
         <div id="q-page">
            <div id="questionario">
                <form id='questionario-doc' method='POST' name='questionario-doc' action='https://qualita.cooperativadoc.it/questionario/response.php'>
                   <input type="hidden" name="from" id="from" value='D' />
                    <div id="quest-logo"><img src="https://qualita.cooperativadoc.it/img/qu-doc.png" /></div>
                    <div class='clear'></div>
                    ...
                    <table cellspacing='0' cellpadding='0'>
                        <tbody>
                            <tr>
                                <td class="blue big left">QUESITO</td>
                                <td class="blue-clear">ECCELLENTE</td>
                                <td class="blue">BUONO</td>
                                <td class="blue-clear">SUFFICIENTE</td>
                                <td class="blue">INSUFFICIENTE</td>
                            </tr>
                            <tr>
                                <td colspan="5" class="orange left">LA VACANZA</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3" class="orange left">L'ALBERGO - LA STRUTTURA - Indicare il nome della struttura ospitante</td>
                            ...
                            <tr>
                                <td colspan="5" class="blue left">SUGGERIMENTI PER MIGLIORARE IL SERVIZIO</td>
                            </tr>
                            <tr>
                                <td colspan="5" class="white left"><textarea id="suggerimenti" name="suggerimenti" rows='6' ></textarea></td>
                            </tr>
                            <tr>
                                <td colspan="5" class="blue left">DATI DEL COMPILATORE</td>
                            </tr>
                            <tr>
                    ...
                    <div class='pulsante'>
                        <a href="javascript:rispondi('D')"  class='sub subblue'>INVIA QUESTIONARIO</a>
                    </div>
                    <div class='clear'></div>
