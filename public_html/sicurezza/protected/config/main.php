...
return array(
    ...
    'modules' => array(
        ...
        'gii' => array(
            ...
            'ipFilters' => array('85.159.145.207', '151.79.141.154'),
            'newFileMode' => 0666,
            'newDirMode' => 0777,
        ),
    ),
    ...
    'components' => array(
         ...
         */
        'db' => array(
            'connectionString' => 'mysql:host=localhost;dbname=cooperativa_qualita',
            'emulatePrepare' => true,
            'username' => 'cooperativadoc',
            'password' => 'coop5369s',
            'charset' => 'utf8',
        ),
        'errorHandler' => array(
