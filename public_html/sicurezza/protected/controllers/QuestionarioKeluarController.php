...
class QuestionarioKeluarController extends Controller {
    ...
    public function actionAdmin() {
        ...
        if (isset($_GET['QuestionarioKeluar']))
            $model->attributes = $_GET['QuestionarioKeluar'];
     ...
     * @return QuestionarioKeluar the loaded model
     ...
     * @param QuestionarioKeluar $model the model to be validated
     */
