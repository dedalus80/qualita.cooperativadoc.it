...
/**
 * This is the model class for table "questionario_doc".
 *
 * The followings are the available columns in table 'questionario_doc':
 * @property integer $id
...
class QuestionarioDoc extends CActiveRecord {
     ...
     * @return QuestionarioDoc the static model class
     */
    ...
    public function getEsportazione() {
        $dati = Yii::app()->db->createCommand("SELECT * FROM questionario_doc ")->queryAll();
        return $dati;
    }
    ...
    public function getStats($attribute, $struttura = null, $periodo = null) {
        ...
        $totale = Yii::app()->db->createCommand("SELECT count(id) FROM  questionario_doc WHERE 1 " . $and . " ")->queryScalar();
        $dati_e = Yii::app()->db->createCommand("SELECT count(id) FROM  questionario_doc WHERE " . $attribute . "='E' " . $and . "")->queryScalar();
        $dati_b = Yii::app()->db->createCommand("SELECT count(id) FROM  questionario_doc WHERE " . $attribute . "='B' " . $and . "")->queryScalar();
        $dati_s = Yii::app()->db->createCommand("SELECT count(id) FROM  questionario_doc WHERE " . $attribute . "='S' " . $and . "")->queryScalar();
        $dati_i = Yii::app()->db->createCommand("SELECT count(id) FROM  questionario_doc WHERE " . $attribute . "='I' " . $and . "")->queryScalar();
    ...
    public function getConsiglia($attribute, $struttura = null, $periodo = null) {
        ...
        $totale = Yii::app()->db->createCommand("SELECT count(id) FROM  questionario_doc WHERE 1 " . $and . "")->queryScalar();
        $dati_S = Yii::app()->db->createCommand("SELECT count(id) FROM  questionario_doc WHERE consiglia='S' " . $and . "")->queryScalar();
        $dati_N = Yii::app()->db->createCommand("SELECT count(id) FROM  questionario_doc WHERE consiglia='N' " . $and . "")->queryScalar();
        $dati_F = Yii::app()->db->createCommand("SELECT count(id) FROM  questionario_doc WHERE consiglia='F' " . $and . "")->queryScalar();
