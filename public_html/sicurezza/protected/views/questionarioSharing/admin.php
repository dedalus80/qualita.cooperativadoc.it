...
$('.search-form form').submit(function(){
	$('#questionario-sharing-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
");
?>
<div class='float_left' style='width: 50%'><h1>Questionari <span class='red'>Sharing</span>  <?= $_SESSION['user']['user_type']==1? "<a href='./esporta'>Esporta Dati</a>":"" ?></h1></div>
        ...
        array('class' => 'CButtonColumn',
            ...
            'buttons' => array
                ...
                'print' => array
                    ...
                    'url' => 'Yii::app()->createUrl("questionarioSharing/stampa", array("id"=>$data->id))',
                ),
            ),
        ),
    ),
