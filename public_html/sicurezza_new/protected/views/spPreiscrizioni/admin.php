...
$this->breadcrumbs = array(
    'Ricerche online Stessopiano' => array('admin'),
    'Gestisci',
);

$this->menu = array(
    array('label' => 'Lista ricerche online', 'url' => array('admin'),  'itemOptions' => array('class' => 'last'))
...
$('.search-form form').submit(function(){
	$('#sp-preiscrizioni-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
");
?>
<div class='float_left' style='width: 75%'><h1>Gestisci ricerche online Stessopiano <?= $_SESSION['user']['id']==102 ||  $_SESSION['user']['id']==1? "<a href='./esporta'>Esporta Dati</a>":"" ?></h1></div>
