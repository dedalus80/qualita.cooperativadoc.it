                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default" style="border: none !important">
                        <div class="panel-heading" style="padding: 30px 30px ;text-align: center;border: none !important;position:relative">
							...
							<a href='http://www.stessopiano.it' target='_blank' title='Stessopiano' ><img src="<?= ASSETS ?>/stessopiano/img/logo-stessopiano.png" id="login-img-top" class="img-responsive" style="display: inline-block" /></a></div>
                                    ...
                                    <div id='box-2' class='hidden-on-start' >
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-7">
												...
												<div  id="studente-extra" style="display: <?= $field['occupazione'] =='1' ? 'block':'none' ?>; padding-top: 5px" >
                                                    ...
                                                    <!--<input data-step='2' class="form-control" name="studente_livello" id="studente_livello" type="text" placeholder="<?= $text[$lang]['label_studente_livello']."*" ?>" value='<?= $field['studente_livello'] ?>' style="padding-top: 5px" />-->
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="box-4" class='hidden-on-start' >
                                        ...
                                        <div class="row row-30">
                                            <div class="col-xs-12  col34">
                                                <input type='checkbox' name='privacy' id='privacy' value='Y' class="check-green" data-refer="privacy" data-step="4" /><label>&nbsp;&nbsp;<?= $text[$lang]['label_condizioni'] ?><em>*</em><span id='error_privacy' class='error-text'  style='disp'></span></label>
											</div>
                                        </div>
                                        <div class="row row-10">
                                            <div class="col-xs-12  col34">
                                                <input type='checkbox' name='consenso' id='consenso' value='Y' class="check-green" /><label>&nbsp;&nbsp;<?= $text[$lang]['label_privacy'] ?></label>
                                            </div>
                                        </div>
                                        <div class="row row-10">
                                            <div class="col-xs-12  col34">
                                                <input type='checkbox' name='mailing' id='mailing' value='Y' class="check-green" /><label>&nbsp;&nbsp;<?= $text[$lang]['label_consenso_new'] ?></label>
                                            </div>
                                        </div>
                                        <div class="row row-30">
                                            <div class="col-xs-6  smal-10">
